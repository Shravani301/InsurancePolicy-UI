...
export class FeaturesComponent {
  features = [
    {
      icon: 'assets/icons/quick-issuance.png', // Replace with appropriate icons
    ...
    {
      icon: 'assets/icons/secure-transactions.png', // New icon for security
    ...
    {
      icon: 'assets/icons/support-team.png',
